...
function createLinks() {
  ...
  let links = {
    linkedin: new TriImage(app.view.width * 0.73, app.view.height * 0.2, btnSize / 4, app.stage, randHex(), 4, false, true, 6, 3, 0.25, "assets/imgs/linkedin.png"),
    git: new TriImage(app.view.width * 0.83, app.view.height * 0.3, btnSize / 6, app.stage, randHex(), 4, false, true, 6, 2, 0.34, "assets/imgs/github.png")
  }
...
var sndCtrl = new TriImage(app.view.width * 0.79, app.view.height * 0.13, Math.min(app.view.width, app.view.height) * 0.1, app.stage, randHex(), 4, false, true, 15, 10, 0.13, "assets/imgs/volume_mute.png");
...
sndCtrl.g.click = function (e) {
  ...
  sndCtrl.setImage("assets/imgs/" + sndImages[sndIndex] + ".png");
